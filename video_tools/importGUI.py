...
#WD
        dummy_wd=wx.StaticText(panel22,wx.ID_ANY,"Working Directory",pos=(7,10))
        b_WD_new=wx.Button(panel22,wx.ID_ANY,"New",pos=(7,30))
        b_WD_old=wx.Button(panel22,wx.ID_ANY,"Old",pos=(100,30))
...
#events
        ...
        self.Bind(wx.EVT_BUTTON,self.OnWDNew,b_WD_new)
        #self.Bind(wx.EVT_BUTTON,self.OnWDOld,b_WD_old)
...
# OnWDNew
    def OnWDNew(self,e):
        import wdGUI 
        wd_dlg=wdGUI.wdGUI(None,"Configure Project")
        wd_dlg.GetPath()
        wd_dlg.Destroy()
# OnWDOld
    def OnWDOld(self,e):
...
# OnProcess()
    def OnProcess(self,e):
        ...
        for i in list_paths:
            ...
            input_file = i
            cp_string=self.CpString(input_name,i,self.WD)
            os.system(cp_string)
            k=k+1
        ...
        if do_convert == True:
            ...
            for i in list_paths:
                 input_name= list_names[k]
                 input_file = i
                 avconv_string=self.AvconvString(input_name,self.WD,target_list)
                 print avconv_string
